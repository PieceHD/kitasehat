      ...
      <div class="section">
        <div class="d-lg-flex flex-lg-row">
          <div class="sub-section">
            <img src="./static/img/vector1.jpg" alt="gambar1" />
          </div>
          <div class="sub-section">
            <span class="" id="subtitle"
              >Kurangi tingkat stroke di Indonesia dengan KitaSehat</span
            >
            <p class="description">
              KitaSehat hadir sebagai aplikasi yang akan membantu anda untuk
